...
export const createProperty = asyncHandler(async (req, res) => {
	...
	if (!agentResult.rows.length) {
		console.log("🛠 Checking agent status for user_id:", user_id);
		console.log("🛠 Query returned:", agentResult.rows);
...
export const sendEnquiry = asyncHandler(async (req, res) => {
	...
	console.log("📨 Sending enquiry for property:", req.params.id);
